                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <button id="editable-sample_new" class="btn btn-primary" onclick="window.location.href='addmanage.jsp'"> > Add New <i class="fa fa-plus"></i></button>
                                        ...
                                        <c:if test="${user.level ne 0}">
                                            <c:if test="${user.level ne 3}">
                                                <tr>
                                                    ...
                                                    <td><a class="edit" href="editmanage.jsp?username=${user.username}&password=${user.password}&level=${user.level}">修改</a></td>
