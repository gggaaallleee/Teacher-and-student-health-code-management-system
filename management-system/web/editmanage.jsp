      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateUser.do">
                <div class="form-group ">
                  <label for="username" class="control-label col-lg-2">工号</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="username" name="username" type="text" value="<%=request.getParameter("username")%>" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="password" class="control-label col-lg-2">密码</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="password" name="password" type="text" value="<%=request.getParameter("password")%>"/>
                  </div>
                </div>
                <div class="form-group ">
                  <label for="level" class="control-label col-lg-2">等级</label>
                  <div class="col-lg-10">
                    <input class="form-control " id="level" name="level" type="text" value="<%=request.getParameter("level")%>" readonly/>
                  </div>
                </div>
