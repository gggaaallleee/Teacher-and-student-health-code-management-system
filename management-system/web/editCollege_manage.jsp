      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateCollege.do">
                <div class="form-group ">
                  <label for="id" class="control-label col-lg-2">学院代码</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="id" name="id" type="text" value="<%=request.getParameter("id")%>" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="name" class="control-label col-lg-2">学院</label>
                  <div class="col-lg-10">
