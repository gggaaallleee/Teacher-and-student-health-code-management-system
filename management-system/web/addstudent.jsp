            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="AddStudent.do">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="id" name="idCard" type="text" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="number" class="control-label col-lg-2">学号</label>
                                    <div class="col-lg-10">
                                        <input class="form-control " id="number" name="studentNo" type="text" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    <label for="major" class="control-label col-lg-2">班级</label>
                                    <div class="col-lg-10">
                                        <input class="form-control " id="class" name="classNo" type="text" />
                                    </div>
                                </div>
