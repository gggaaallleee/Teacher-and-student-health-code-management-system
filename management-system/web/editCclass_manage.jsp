      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateClass.do">
                <div class="form-group ">
                  <label for="name" class="control-label col-lg-2">班级</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="name" name="name" type="text" value="<%=request.getParameter("name")%>" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="Cmajor" class="control-label col-lg-2">专业</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="Cmajor" name="Cmajor" type="text" value="<%=request.getParameter("Cmajor")%>"/>
                  </div>
                </div>
                <div class="form-group">
