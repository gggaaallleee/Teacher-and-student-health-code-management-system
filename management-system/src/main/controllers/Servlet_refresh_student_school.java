...
@WebServlet("/Servlet_refresh_student_school")
public class Servlet_refresh_student_school extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Student_table_school.jsp").forward(request,response);
    }
}
