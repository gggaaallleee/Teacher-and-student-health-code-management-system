...
@WebServlet("/Servlet_refresh_teacher_health_table")
public class Servlet_refresh_teacher_health_table extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("health_table.jsp").forward(request,response);
    }
}
