...
@WebServlet("/Servlet_refresh_teacher_health_table_college")
public class Servlet_refresh_teacher_health_table_college extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("health_table_teacher_college.jsp").forward(request,response);
    }
}
