...
@WebServlet("/Servlet_refresh_teacher_school")
public class Servlet_refresh_teacher_school extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Teacher_table_school.jsp").forward(request,response);
    }
}
