      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateTeacher.do">
                ...
                <div class="form-group ">
                  <label for="number" class="control-label col-lg-2">工号</label>
                  <div class="col-lg-10">
                    <input class="form-control " id="number" name="workNo" type="text" value="<%=request.getParameter("workNo")%>" readonly/>
                  </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                  <label for="role" class="control-label col-lg-2">角色</label>
                  <div class="col-lg-10">
