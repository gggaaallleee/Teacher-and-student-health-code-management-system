    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="Servlet_refresh_index"><i class="fa fa-sign-in"></i> <span>登出</span></a></li>
                            ...
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <%
                                        ...
                                        list=(List<Major>)request.getAttribute("major_list");
                                    %>
                                    ...
                                    <tr>
                                        <td>${major.name}</td>
                                        <td>${major.college}</td>
                                        <td><a  href="UpdateMajor.do?name=${major.name}&college=${major.college}">修改</a></td>
                                        <td><a  href="DeleteMajor.do?name=${major.name}">Delete</a></td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
