<%@ page import="main.models.College" %>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <button id="editable-sample_new" class="btn btn-primary" onclick="window.location.href='addCollege_manage.jsp'"> > Add New <i class="fa fa-plus"></i></button>

                                    </div>
                                    <form action="BatchAddCollege.do" method="post" enctype="multipart/form-data">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <%
                                        ...
                                        list=(List<College>)request.getAttribute("college_list");
                                    %>
                                    ...
                                    <tr>
                                        <td>${college.id}</td>
                                        <td>${college.name}</td>
                                        <td><a  href="UpdateCollege.do?id=${college.id}&name=${college.name}">修改</a></td>
                                        <td><a  href="DeleteCollege.do?id=${college.id}">Delete</a></td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
