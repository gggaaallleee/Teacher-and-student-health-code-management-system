      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateStudent.do">
                <div class="form-group ">
                  <label for="name" class="control-label col-lg-2">姓名</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="name" name="name" type="text" value="<%=request.getParameter("name")%>" />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="id" class="control-label col-lg-2">身份证号</label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="id" name="idCard" type="text" value="<%=request.getParameter("idCard")%>"/>
                  </div>
                </div>
                <div class="form-group ">
                  <label for="number" class="control-label col-lg-2">学号</label>
                  <div class="col-lg-10">
                    <input class="form-control " id="number" name="studentNo" type="text" value="<%=request.getParameter("StudentNo")%>" readonly/>
                  </div>
                </div>
                <div class="form-group ">
                  <label for="college" class="control-label col-lg-2">学院</label>
                  <div class="col-lg-10">
                    <input class="form-control " id="college" name="college" type="text" value="<%=request.getParameter("college")%>"/>
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control " id="major" name="major" type="text" value="<%=request.getParameter("major")%>"/>
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control " id="class" name="classNo" type="text" value="<%=request.getParameter("classNo")%>"/>
                  </div>
                </div>
