      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal adminex-form" id="signupForm" method="get" action="UpdateMajor.do">
                <div class="form-group ">
                  <label for="name" class="control-label col-lg-2">专业</label>
                  <div class="col-lg-10">
